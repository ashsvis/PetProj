...
namespace PetProj.Common
{
    /// <author>
    /// Storm23
    /// https://www.cyberforum.ru/blogs/529033/3507.html
    /// 23.04.2015 11:59
    /// </author>
    /// <summary>
    /// Обёртка над Bitmap для быстрого чтения и изменения пикселов.
    /// Также, класс контролирует выход за пределы изображения: при чтении за границей изображения - возвращает DefaultColor,
    /// при записи за границей изображения - игнорирует присвоение.
    /// </summary>
    public class ImageWrapper : IDisposable, IEnumerable<Point>
    {
        ...
        /// <summary>
        /// Цвет по-умолчанию (используется при выходе координат за пределы изображения)
        /// </summary>
        ...
        /// <summary>
        /// Создание обёртки поверх bitmap.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает пиксел из исходного изображения.
        /// Либо заносит пиксел в выходной буфер.
        /// </summary>
