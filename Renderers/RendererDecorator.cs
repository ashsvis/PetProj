...
namespace PetProj.Renderers
{
    ...
    public abstract class RendererDecorator : Renderer
    {
        ...
        public static List<RendererDecorator> GetDecorators(Renderer renderer, List<RendererDecorator> list = null)
        {
            ...
            if (!(renderer is RendererDecorator rendererDecorator)) return list;
            list.Add(rendererDecorator);
            return GetDecorators(rendererDecorator.renderer, list);
        }
        ...
        {
            if (!(renderer is RendererDecorator rendererDecorator)) return false;
            return rendererDecorator.GetType() == decoratorType ||
                ContainsType(rendererDecorator.renderer, decoratorType);
        }
        ...
        public static Renderer GetDecorator(Renderer renderer, Type decoratorType)
        {
            ...
            return GetDecorator(rendererDecorator.renderer, decoratorType);
        }
        ...
        {
            return !(renderer is RendererDecorator rendererDecorator) ? renderer : GetBaseRenderer(rendererDecorator.renderer);
        }
        ...
        public static bool IsNotContainsDecorator(Figure figure, Type type)
        {
            return !ContainsType(figure.Renderer, type);
        }
        ...
        public static bool IsContainsDecorator(Figure figure, Type type)
        {
            return ContainsType(figure.Renderer, type);
        }
